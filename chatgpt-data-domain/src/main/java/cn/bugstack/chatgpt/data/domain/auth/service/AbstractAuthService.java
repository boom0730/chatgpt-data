...
public abstract class AbstractAuthService implements IAuthService {
    ...
    private static final String defaultBase64EncodedSecretKey = "9GzNajD9y1f1vz4nxp7PMvtrvnjGZxGRQI7DxOEBTuu";
    ...
    public AuthStateEntity doLogin(String code) {
        ...
        // 2. 校验判断，非成功则直接返回
        /**
         * ！！！！！ 这里校验 checkCode验证码的逻辑是
         * 只要这个验证码在缓存中 那么就认为验证码是正确的
         */
